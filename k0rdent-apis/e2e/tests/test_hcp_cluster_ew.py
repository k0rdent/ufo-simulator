"""Smoke: HCP cluster with Netris east-west fabric + rail NICs."""
...
def test_hcp_cluster_ew_create_ready_terminate(
    ...
    """Ensure globals, create Netris E/W HCP cluster, wait ready, delete."""
    log = Steps("HCP E/W cluster create → ready → terminate")
